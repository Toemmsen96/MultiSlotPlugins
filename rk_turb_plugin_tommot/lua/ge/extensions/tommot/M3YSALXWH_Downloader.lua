...
local reqExtensionName = "" -- Name of the extension to check for, if it is a lua extension
-- List of possible mod names to check, will get converted to lowercase
local reqModNames = {
        "Turbo_Everything_rk",
        "TommoT_GMSG"
}
local reqModID = "M3YSALXWH" -- Mod ID to check for / subscribe to
local creatorName = "tommot" -- Name of the creator of this extension, needs to match the creator name in the extensions folder
local extensionName = "M3YSALXWH_Downloader" -- Name of this extension, preferably using the reqModID and "Downloader" or similar, needs to match the name in the extensions folder
local failureMessage = "This requires the Turbo + Twincharge Everything - Mod to be installed" -- Message to display if the required mod is not found
--------------------------------------------------------------------------------
